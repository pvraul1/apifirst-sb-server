...
public class OpenApiValidationConfig {
    ...
    public WebMvcConfigurer openAPIValidationInterceptor() {
        ...
        OpenApiInteractionValidator validator = OpenApiInteractionValidator
                .createForSpecificationUrl("https://api.redocly.com/registry/bundle/spring-framework-guru/API%20First%20With%20Spring%20Boot%20-%20Development/v1/openapi.yaml?branch=development")
                .build();
